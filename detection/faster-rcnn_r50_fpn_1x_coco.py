_base_ = [
    ...
    '/home/tureckova/Code/mmdetection/configs' + '/_base_/schedules/schedule_2x.py',
...
visualizer = dict(
    ...
    name='visualizer')
work_dir = '/mnt/SSD1TB/TACR_TREND/models/tomato_row/360ann_v2.1_faster-rcnn_r50_fpn_1x/assahi-oneclass-24epoch/'